...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Информация о создателе","2.  Информация о том, как устроено приложение","1.1. Информация о маршрутах"],
    DREX_NODE_LINKS: ["index.htm","informatsiya_o_sozdatele.htm","_informatsiya_o_tom__kak_ustroeno_prilozhenie.htm","informatsiya_o_marshrutakh.htm"],
    DREX_NODE_CHILD_START: [1,3,4,4],
    DREX_NODE_CHILD_END: [3,4,4,4],
    DREX_MENU_TYPE: 2,
